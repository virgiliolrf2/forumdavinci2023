const countries = [
    ...
    { elem: document.querySelector('.sud'), flag: '/tipos de abordagens/debatemoderado/ucrania.png', name: 'Ucrânia' },
    { elem: document.querySelector('.br'), flag: '/tipos de abordagens/debatemoderado/brasil.png', name: 'Brasil' },
    { elem: document.querySelector('.eg'), flag: '/tipos de abordagens/debatemoderado/arabia.png', name: 'Arábia saudita' },
    { elem: document.querySelector('.afs'), flag: '/tipos de abordagens/debatemoderado/africadosul.png', name: 'África do Sul' },
    { elem: document.querySelector('.jap'), flag: '/tipos de abordagens/debatemoderado/japao.png', name: 'Japão' },
    { elem: document.querySelector('.eti'), flag: '/tipos de abordagens/debatemoderado/bielorrussia.png', name: 'Bielorrussia' },
    ...
    { elem: document.querySelector('.isr'), flag: '/tipos de abordagens/debatemoderado/israel.png', name: 'Israel' },
    { elem: document.querySelector('.ua'), flag: '/tipos de abordagens/debatemoderado/polonia.png', name: 'Polônia' }
];
