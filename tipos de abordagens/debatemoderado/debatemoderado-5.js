...
const turq = document.querySelector('.turq');
...
function moverCopiaSud() {
    imagem.src = 'ucrania.png';
    nome.textContent = 'Ucrânia';
    if (copiaSud) {
...
function moverCopiaEg() {
    imagem.src = 'arabia.png';
    nome.textContent = 'Arábia saudita';
    if (copiaEg) {
...
function moverCopiaEti() {
    imagem.src = 'bielorrussia.png';
    nome.textContent = 'Bielorrussia';
}
...
function moverCopiaUa() {
    imagem.src = 'polonia.png';
    nome.textContent = 'Polônia';
    if (copiaUa) {
...
ale.addEventListener('click', moverCopiaAle);
ira.addEventListener('click', moverCopiaIra);
ind.addEventListener('click', moverCopiaInd);
turq.addEventListener('click', moverCopiaTurq);
